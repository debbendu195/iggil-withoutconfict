...
class PracticeManagerListScreen extends StatelessWidget {
  const PracticeManagerListScreen({super.key});
  ...
  final List<Map<String, String>> items = const [
    {
      ...
      'route' : AppRoutes.practiceManagerProfileScreen,
    },
    {
      ...
      'route' : AppRoutes.practiceManagmentArchives,
    },    {
      'image': AppImages.icon5,
      'title': 'Invoices',
      'subtitle': 'Billings & payments',
      'route' : AppRoutes.practiceManagerInvoiceListView,
    },    {
      'image': AppImages.icon6,
      'title': 'Downloads',
      'subtitle': 'Forms & documents',
      'route' : AppRoutes.practiceManagerDownload,
    }, {
      'image': AppImages.icon1,
      'title': 'Contact Us',
      'subtitle': 'Get in touch',
      'route' : AppRoutes.practiceManagerContact,
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: PracticeManagetNavbar(currentIndex: 0),
    );
  }
}

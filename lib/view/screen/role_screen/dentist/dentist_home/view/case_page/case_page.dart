...
class CaseDocumentScreen extends StatelessWidget {
  ...
  final CaseHomeController caseHomeController = Get.put(CaseHomeController());
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      caseHomeController.getSingleCasesData(caseId: caseId);
    });

    return Scaffold(
      appBar: CustomRoyelAppbar(leftIcon: true, titleName: 'caseDocument'.tr, color: AppColors.primary,),

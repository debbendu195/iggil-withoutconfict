...
class DentistCaseList extends StatelessWidget {
  const DentistCaseList({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomRoyelAppbar(leftIcon: true, titleName: 'All Case List', color: AppColors.primary,),
      body: SafeArea(
        child: Column(
          children: [

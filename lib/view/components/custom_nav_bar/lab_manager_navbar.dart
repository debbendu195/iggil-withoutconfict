...
class LabManagerNavbar extends StatefulWidget {
  ...
  const LabManagerNavbar({required this.currentIndex, super.key});

  @override
  State<LabManagerNavbar> createState() => _NavBarState();
}

class _NavBarState extends State<LabManagerNavbar> {

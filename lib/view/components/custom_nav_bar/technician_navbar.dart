...
class TechnicianNavbar extends StatefulWidget {
  ...
  const TechnicianNavbar({required this.currentIndex, super.key});

  @override
  State<TechnicianNavbar> createState() => _UserNavBarState();
}

class _UserNavBarState extends State<TechnicianNavbar> {
